...
function SearchContent() {
    ...
    const [input, setInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(initialQ);
    const debouncedInput = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useDebounce$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useDebounce"])(input, 400);
    ...
    const loadResults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (reset = false)=>{
        if (!debouncedInput || loading || done && !reset) return;
        setLoading(true);
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/youtube/search", {
            params: {
                q: debouncedInput,
    ...
    const sentinelRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useInfiniteScroll$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useInfiniteScroll"])(()=>loadResults(), !loading && !done);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1o_efdp._.js.map